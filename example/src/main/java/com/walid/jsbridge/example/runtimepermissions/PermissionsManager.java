 ...
 */
package com.walid.jsbridge.example.runtimepermissions;
...
public class PermissionsManager {
   ...
   * since they do not exist, they will be denied when you checkVersion whether you have permission
   * which is problematic since a new permission is often added where there was no previous
   * permission required. We initialize a Set of available permissions and checkVersion the set
   ...
   *
   * @param activity the Activity necessary to checkVersion what permissions we have.
   ...
   * you immediately wish to hide the pending action from the queue and
   * execute the action.
   *
  ...
  /**
   * This static method can be used to checkVersion whether or not you have a specific permission.
   ...
   * in a null Context object, it will return false as otherwise it cannot checkVersion the permission.
   ...
   *
   * @param context    the Context necessary to checkVersion the permission
   * @param permission the permission to checkVersion
  ...
  /**
   * This static method can be used to checkVersion whether or not you have several specific permissions.
   ...
   * If you pass in a null Context object, it will return false as otherwise it cannot checkVersion the
   ...
   *
   * @param context     the Context necessary to checkVersion the permission
   * @param permissions the permissions to checkVersion
   ...
   *
   * @param activity the Activity necessary to request and checkVersion permissions.
   ...
   * will fail to work as the activity reference is necessary to checkVersion for permissions.
   *
   ...
   * in the queue, and will hide the permissions request from the list of pending requests.
   *
