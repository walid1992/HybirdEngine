 ...
 * creating an anonymous getInstance of it and passing that getInstance to the
...
public abstract class PermissionsResultAction {
   ...
   * Default Constructor
   */
  protected PermissionsResultAction() {}

  /**
   * Alternate Constructor. Pass the looper you wish the PermissionsResultAction
   * callbacks to be executed on if it is not the current Looper. For getInstance,
